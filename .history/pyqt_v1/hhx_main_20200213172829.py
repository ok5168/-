...
if __name__ == '__main__':
    ...
    # myWin.dateEdit.setDateTime(QtCore.QDateTime(QtCore.QDate(1990, 1, 1), QtCore.QTime(0, 0, 0))) #设成指定日期
    myWin.dateEdit.setDateTime(QtCore.QDateTime.currentDateTime()) #默认设成现在的日期
