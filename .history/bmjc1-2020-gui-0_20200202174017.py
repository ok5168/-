...
# fieldValues = g.multenterbox("请提供以下信息:", biaoti, fieldNames)
fieldValues =g.multenterbox(msg='请提供以下信息:', title=biaoti, fields=fieldNames, values=(6,2011-11-12))
path=fieldValues[0]
mytime0=fieldValues[1]
